...
void MediaMTXManager::generateConfig(QAbstractItemModel* model)
{
    ...
    for (int i = 0; i < model->rowCount(); ++i)
    {
        ...
        // (duplikat mapowania YAML - drugi, HTTP-owy wpis nadpisywał
        // pierwszy, więc "runOnInitRestart: yes" z pierwszego wpisu i tak
        // nigdy nie obowiązywał), a kamery HTTP nie trafiały do configu
